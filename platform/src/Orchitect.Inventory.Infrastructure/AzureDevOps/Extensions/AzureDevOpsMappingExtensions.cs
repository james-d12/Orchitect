...
public static class AzureDevOpsMappingExtensions
{
        ...
        Uri projectUri)
    {
        ...
        {
            PullRequestStatus.NotSet => Orchitect.Inventory.Domain.Git.PullRequestStatus.Draft,
            PullRequestStatus.Active => Orchitect.Inventory.Domain.Git.PullRequestStatus.Active,
            PullRequestStatus.Abandoned => Orchitect.Inventory.Domain.Git.PullRequestStatus.Abandoned,
            PullRequestStatus.Completed => Orchitect.Inventory.Domain.Git.PullRequestStatus.Completed,
            PullRequestStatus.All => Orchitect.Inventory.Domain.Git.PullRequestStatus.Unknown,
            _ => Orchitect.Inventory.Domain.Git.PullRequestStatus.Unknown
        };
