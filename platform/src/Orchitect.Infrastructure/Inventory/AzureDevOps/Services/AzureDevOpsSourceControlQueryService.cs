...
public sealed class AzureDevOpsSourceControlQueryService : ISourceControlQueryService
{
    private readonly ILogger<AzureDevOpsSourceControlQueryService> _logger;
    private readonly IRepositoryRepository _repositoryRepository;
    private readonly IPipelineRepository _pipelineRepository;
    private readonly IPullRequestRepository _pullRequestRepository;

    public AzureDevOpsSourceControlQueryService(
        ILogger<AzureDevOpsSourceControlQueryService> logger,
