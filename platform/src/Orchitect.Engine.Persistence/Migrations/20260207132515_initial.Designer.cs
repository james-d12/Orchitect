...
namespace Orchitect.Engine.Persistence.Migrations
{
    ...
    [Migration("20260207132515_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orchitect.Engine.Domain.Organisation.Organisation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Orchitect.Engine.Domain.Organisation.OrganisationService", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Orchitect.Engine.Domain.Organisation.OrganisationTeam", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Orchitect.Engine.Domain.Organisation.OrganisationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Orchitect.Engine.Domain.Application.Application", b =>
                {
                    b.HasOne("Orchitect.Engine.Domain.Organisation.Organisation", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OrganisationTeamUsers", b =>
                {
                    b.HasOne("Orchitect.Engine.Domain.Organisation.OrganisationTeam", null)
                        .WithMany()
                        .HasForeignKey("OrganisationTeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Orchitect.Engine.Domain.Organisation.OrganisationUser", null)
                        .WithMany()
