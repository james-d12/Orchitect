# Conductor Architecture Summary

This document summarizes the architectural insights and direction discussed regarding the evolution of Conductor and related tooling.

---

## Overview

Conductor will consist of **three distinct but complementary products**, each addressing a different plane of a modern Internal Developer Platform (IDP):

1. **Conductor.Platform** — Provisioning, orchestration, environment management
2. **Conductor.Inventory** — Discovery and cataloging of existing infrastructure, repos, pipelines
3. **Conductor.Intelligence** — Deep code insights, dependency analysis, modernization scoring
...
- **The Conductor Engine**: A platform orchestrator for provisioning and managing new infrastructure.
...
## The Three Conductor Products

### 1. **Conductor.Platform**
**Purpose:**  
...
**Position:**  
This is the *Control Plane* of Conductor.
...
- Cohesive as a family of products under the **Conductor** brand
